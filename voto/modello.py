...
class Libretto:
    def __init__(self, proprietario, voti=[]):
        ...
        self.voti = voti
        self.dao = LibrettoDAO() #CREIAMO UNA ISTANDA DEL DAO NEL MODELLO PER ACCEDERE AL DATABASE
        self.fillLibretto()

    def fillLibretto(self):
        allEsami = self.dao.getAllVoti()
        for e in allEsami:
            self.append(e) #APPENT E' IL METODO SCRITTO SOTTO, NON IL SOLITO APPEND CHE USIAMO CON LE LISTE
